...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, FormUrlComponent, OutputUrlComponent, ErrorComponent, NavBarComponent, RegisterUserComponent],
